...
const LOCAL_IMAGES: Record<number, string[] | Record<string, string[]>> = {
  ...
  432626242: { // Loadout Lab Logo Hat — per-color
    'Black': [
      ...
      '/products/hat2/black/2.jpg',
    ],
    'Navy': ['/products/hat2/navy/1.jpg'],
    'Cranberry': ['/products/hat2/cranberry/1.jpg'],
    'Spruce': ['/products/hat2/spruce/1.jpg'],
    'Dark Grey': ['/products/hat2/dark-grey/1.jpg'],
    'Green Camo': ['/products/hat2/green-camo/1.jpg'],
    'Stone': ['/products/hat2/stone/1.jpg'],
    'Pink': ['/products/hat2/pink/1.jpg'],
    'Light Blue': ['/products/hat2/light-blue/1.jpg'],
  },
  432627030: [ // New Patch
  ...
  432629722: { // Control, Test, Improve Graphic Tee — per-color
    'Black': [
      ...
      '/products/tee2/black/5.jpg',
    ],
    'Navy': [
      '/products/tee2/navy/1.jpg',
      '/products/tee2/navy/2.jpg',
    ],
  },
};
